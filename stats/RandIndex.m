...
% INPUTS:
%   c1 - vector listing the class membership for cluster solution / partitioning 1
%   c2 - vector listing the class membership for cluster solution / partitioning 2
% RETURNS:
%   AR - Hubert & Arabie adjusted rand index
...
function [AR,RI,MI,HI] = RandIndex(c1, c2)
    ...
    A = t1 + t2 - t3; % num agreements
    D = -t2 + t3; % num disagreements

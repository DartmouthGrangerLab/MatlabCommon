function [s2,c2,bestBands,bestLocations] = C2 (img, filterSizes, c1Space, c1Scale, linearPatches, patchSize, c1, IGNOREPARTIALS, ALLS2C1PRUNE, ORIENTATIONS2C1PRUNE)
...
%
%     linearPatches: a 2-dimensional matrix, the prototypes (patches) used in the extraction of s2.
%     Each patch of size [m,n,d] is stored as a column in linearPatches, which has itself a size of [m*n*d, n_patches];
%
%     patchSize: a 3-element vector, [m n d], describing the size of each patch in 'linearPatches'.
%     m is the number of rows, n the number of columns, and d the number of orientations.
%
%     c1: a precomputed c1 layer can be used to save computation time if available.
%     The proper format is the output of C1.m
%

...
%   n
%   p
%   margins - (OPTIONAL) two elements vector [vertical,horizontal] defining the margins between neighbouring axes. Default value
...
%   varargin - additional arguments are passed to matlab's subplot()

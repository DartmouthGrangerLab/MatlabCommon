...
%           .nodeName     - 1 x n_tot_nodes (cell) name of each node
%           .skelName     - 1 x n_tot_nodes (cell)
%           .pos          - 3 x n_tot_nodes x n_frames (double) [x,y,z] for each node
%           .line         - 2 x n_tot_lines (double) index into node list ([start of line, end of line]) (assumed consistent set across frames - only their positions change)
%           .joint        - 3 x n_tot_joints (double) index into node list ([end of line 1, pivot point, end of line 2]) (assumed consistent set across frames - only their angles and positions change)
%   descriptors - 1 x N (cell) file descriptors

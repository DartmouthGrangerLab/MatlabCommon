...
% modified by Eli Bowen 12/2020 for readability and to remove the gui progress bar
        ...
        if speedUp  
            ...
            for i = 1:NvideoFrames
                ...
                for j = 1:NanalogFramesPerVideoFrame
                    AnalogSignals(j+NanalogFramesPerVideoFrame*(i-1),1:NanalogChannels) = fread(fid, NanalogChannels, 'int16')';
                end
            end
        end
    else
...
%                 CameraInfo(i,j) = fread(fid,1,'int8');
            ...
            for j = 1:NanalogFramesPerVideoFrame
%                AnalogSignals(j+NanalogFramesPerVideoFrame*(i-1),1:NanalogChannels) = fread(fid,NanalogChannels,'int16')';
               AnalogSignals(j+NanalogFramesPerVideoFrame*(i-1),1:NanalogChannels) = freadVAXD(fid,NanalogChannels,'int16')';
            end
            fprintf('\b\b\b\b\b', i);
        end
    end

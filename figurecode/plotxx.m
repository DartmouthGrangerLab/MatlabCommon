...
%Similar to plotyy(), but with two x axes instead of two y axes
%
%Syntax: [ax,hl1,hl2] = plotxx(x1,y1,x2,y2,xlabels,ylabels);
%
%INPUTS:
%   X1,Y1 are the data for the first line (black)
...
%
%The code is inspired from page 10-26 (Multiaxis axes) of the manual USING MATLAB GRAPHICS, version 5.
%Author: Denis Gilbert, Ph.D., physical oceanography
%Maurice Lamontagne Institute, Dept. of Fisheries and Oceans Canada
%email: gilbertd@dfo-mpo.gc.ca  Web: http://www.qc.dfo-mpo.gc.ca/iml/
%November 1997; Last revision: 01-Nov-2001
%Grabbed by Eli Bowen from: http://www.mathworks.com/matlabcentral/fileexchange/317-plotxx-m/content/plotxx.m

...
%   into one new structure X. X contains all fields present in the various structures. An example:
%     A.name = 'Me' ;
%     B.income = 99999 ;
%     X = catstruct(A,B)
%     % -> X.name = 'Me' ;
...
%
%   NOTE: To concatenate similar arrays of structs, you can use simple concatenation:

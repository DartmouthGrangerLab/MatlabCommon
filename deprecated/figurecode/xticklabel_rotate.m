...
%                           uses current XTick values or XTickLabel cell array by default (if empty) 
...
%
%From: http://www.mathworks.com/matlabcentral/fileexchange/3486-xticklabel-rotate/content/xticklabel_rotate.m
%This is a modified version of xticklabel_rotate90 by Denis Gilbert
%Modifications include:
%   Text labels (in the form of cell array)
%	Arbitrary angle rotation
%	Output of text handles
%	Resizing of axes and title/xlabel/ylabel positions to maintain same overall size and keep text on plot
...
%Minor additional modifications by Eli Bowen
% Brian FG Katz
% bfgkatz@hotmail.com
% 23-05-03
...
%Minor additional modifications in 2015 by Eli Bowen
%Subfunctions: none
...
function hText = xticklabel_rotate (XTick, rot, varargin)
    ...
    if ~iscell(xTickLabels)
        ...
        for cnt=1:length(XTick)
           hText(cnt) = text(XTick(cnt), y(cnt), xTickLabels{cnt}, 'VerticalAlignment', 'top', 'UserData', 'xtick');
        end
    end

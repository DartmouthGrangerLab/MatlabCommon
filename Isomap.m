...
% downloaded by Eli on 7/5/2017 from: http://web.mit.edu/cocosci/isomap/code/Isomap.m
...
%
%    This code is provided as is, with no guarantees except that bugs are almost surely present.
...
%    I would also appreciate hearing about how you used this code, improvements that you have made to it, or translations into other languages.
%
...
function [Y, R, E] = Isomap(D, n_fcn, n_size, options)
    ...
    % algorithm can be found in isomap2.m (and the accompanying files dijkstra.c and dijkstra.dll).
    tic;
    for k = 1:N
...
% Copyright notice: You are free to modify, extend and distribute this code granted that the author of the original code is mentioned as the original author of the code.
% Fixed by JBT (3/18/00) to work for 1-dimensional vectors
% and to warn for imaginary numbers.  Also ensures that
% output is all real, and allows the option of forcing diagonals to be zero.
